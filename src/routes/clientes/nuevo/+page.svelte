<script>
	...
	async function handleSubmit(e) {
		...
		try {
			...
			// Guardar offline-first (funciona con o sin internet)
	...
	<div class="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
		...
		<div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
			...
			<form onsubmit={handleSubmit} class="p-6 space-y-6">
				...
				<div>
					<h2 class="text-lg font-bold text-gray-800 mb-4 pb-2 border-b-2 border-blue-600">📋 Información Personal</h2>
				...
				<!-- Dirección -->
				<div>
					<h2 class="text-lg font-bold text-gray-800 mb-4 pb-2 border-b-2 border-blue-600">📍 Dirección</h2>
					<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
						<div class="md:col-span-2">
				...
				<div>
					<h2 class="text-lg font-bold text-gray-800 mb-4 pb-2 border-b-2 border-blue-600">👤 Información del Fiador (Opcional)</h2>
					<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
						<div>
				...
				{#if success}
					<div class="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-xl">
						✅ Cliente guardado localmente. Se sincronizará cuando tengas internet
					</div>
				{/if}
